...
export default function ClaimFormPage() {
  ...
  const [startDate, setStartDate] = useState<string>(format(startOfMonth(new Date('2025-01-24')), 'yyyy-MM-dd'))
  const [endDate, setEndDate] = useState<string>(format(endOfMonth(new Date('2025-01-24')), 'yyyy-MM-dd'))
